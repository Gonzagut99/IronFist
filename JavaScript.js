...
let swalWidth= ()=>{
    ...
    let swalWidth = (anchoPantalla>800)?"50%":"100%";
    return swalWidth;
}
  ...
  function Aumentar_Puntos() {
    ...
    if (Puntaje == puntajeParaGanar) {
      ...
      function Habilitar_Siguienten_LVL() {
        ...
        document.getElementById("replayGameButton").style.display='none';
        document.getElementById("NIVEL_01").style.display = "none";
        document.getElementById("NIVEL_02").style.display = "block";
      }
      botonPausar.style.display = "none";
      document.getElementById("Tiempo").innerHTML = lastTimeValue + " seg.";
      document.getElementById("Puntaje").innerHTML = lastPuntajeValue + "&nbsp;/&nbsp;" + 5;
...
let nivel01Contenedor= document.getElementById("NIVEL_01");
//let lvl1Clon =  nivel01Contenedor.cloneNode(true);
document.getElementById("Fondo_Ciberpunk").pause();
...
function PLAY() {
  ...
  document.getElementById('Contenedor_Mensaje_Star').style.display='none'
  ...
  tiempo_de_arranque = setTimeout(ARRACAR, 3100);
...
const sección2Historia=document.getElementById('Seccion_2')
sección2Historia.style.display='none';
function Mover_2() {
  sección2Historia.style.display='block';
...
function Mover_3() {
  ...
  let nivel1Container = document.getElementById("NIVEL_01");
  ...
  function Desaparaceer3() {
    ...
    var contenedor_2 = document.getElementById("Seccion_2");
    var juego = document.getElementById("Registrar");
