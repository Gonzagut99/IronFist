...
function JUEGOlvl2() {
  const botonPausar = document.getElementById("Pauselvl2");
  ...
  function Aumentar_Puntoslvl2() {
    Puntajelvl2++;
    let puntajeParaGanar = 2;
    let lastTimeValue = Tiempolvl2;
    ...
    if (Puntajelvl2 == puntajeParaGanar) {
      Puntajelvl2 = 0;
      Tiempolvl2 = 61;

      botonPausar.style.display = "none";
      document.getElementById("Tiempolvl2").innerHTML = lastTimeValue;
      document.getElementById("Puntajelvl2").innerHTML =
        lastPuntajeValue + "&nbsp;/&nbsp;" + puntajeParaGanar;
      ...
      function Habilitar_Siguienten_LVL() {
        ...
        //Como nay mas niveles se esconde el boton de siguiente nivel
...
function PLAYlvl2() {
  ...
  tiempo_de_arranquelvl2 = setTimeout(ARRACARlvl2, 3100);
